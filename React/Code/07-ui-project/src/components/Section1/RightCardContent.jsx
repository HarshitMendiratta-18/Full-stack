...
const RightCardContent = (props) => {
  return (
    <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
        ...
        <div>
          <p className="text-xl text-shadow-2xs leading-relaxed text-white mb-14">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eligendi ab voluptate adipisci quibusdam? Voluptatem, accusamus.</p>
